...
describe AccountsController do
  describe 'creating account' do
    ...
    it 'should create a flash message if a username already exists' do
      post :create, account: { username: 'valid', email: 'test@gmail.com', password: 'valid123!!' }
    ...
    it 'should redirect you to the login page if account is created successfully' do
      post :create, account: { username: 'test', email: 'test@gmail.com', password: 'valid123!!' }
    ...
    it 'should create a new account if the account is valid' do
      post :create, account: { username: 'testusername', email: 'test@gmail.com', password: 'valid123!!' }
    ...
    it 'should create flash message if the email is an invalid address' do
      post :create, account: { username: 'test', email: 'testgmail.com', password: 'valid123!!' }
